export const translations = {
  ru: {
    ...
    hero_title: 'Изучайте английский язык быстро и эффективно',
    hero_desc: 'Специализированная подготовка к IELTS, CEFR. Мы предоставляем минималистичную и сфокусированную среду.',
    hero_joined: '500+ студентов',
    ...
    form_button: 'Зарегистрироваться',
